...
cat > my.cfg << 'EOT'
{
    ...
    "workdir": "./lab/soft/syzkaller/workdir",
    "kernel_src": "./lab/soft/kernel",
    "image": "./lab/soft/image/trixie.img",
    "sshkey": "./lab/soft/image/trixie.id_rsa",
    "ssh_user": "root",
    "syzkaller": "./lab/soft/syzkaller",
    "procs": 8,
    "type": "qemu",
    "vm": {
        "count": 3,
        "kernel": "./lab/soft/kernel/arch/x86/boot/bzImage",
